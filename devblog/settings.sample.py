...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "metablog.context_processors.config",
    "metablog.context_processors.site",
)
...
DISQUS_API_KEY = 'myapikey'
DISQUS_WEBSITE_SHORTNAME = 'myname'
